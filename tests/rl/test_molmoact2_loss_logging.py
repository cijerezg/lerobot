...
def test_objective_wandb_scalars_include_headlines_only() -> None:
    summary = {
        ...
        "action_aux_band_dc_mse": {"val": 5.0},
...
def test_training_wandb_metrics_use_compact_allowlist() -> None:
    ...
    metrics = {
        ...
        "action_aux/tempered_mse_p50": 0.6,
        "action_aux/band_dc_mse_mean": 0.03,
        "actor_loss_histogram": object(),
        "depth_block3_token_rms": 1.2,
        "discrete_aux/band_dc_ordinal_ce_mean": 0.9,
        "discrete_aux/path_relative_mean": 0.8,
