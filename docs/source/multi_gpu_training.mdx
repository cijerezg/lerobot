...
4. **Single process logging**: Only the main process logs to Aim and saves checkpoints
...
- Aim integration automatically initializes only on the main process, preventing multiple runs from being created.
