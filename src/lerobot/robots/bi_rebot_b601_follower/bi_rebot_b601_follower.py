...
class BiRebotB601Follower(Robot):
    ...
    def __init__(self, config: BiRebotB601FollowerConfig):
        ...
        left_arm_config = RebotB601FollowerRobotConfig(
            ...
            park_pose=config.left_arm_config.park_pose,
            park_deg_per_s=config.left_arm_config.park_deg_per_s,
            park_tolerance_deg=config.left_arm_config.park_tolerance_deg,
        ...
        right_arm_config = RebotB601FollowerRobotConfig(
            ...
            park_pose=config.right_arm_config.park_pose,
            park_deg_per_s=config.right_arm_config.park_deg_per_s,
            park_tolerance_deg=config.right_arm_config.park_tolerance_deg,
