...
class RebotArm102Leader(Teleoperator):
    ...
    The encoder-only 102LD keeps the motorbridge read path. The actuated 102HD uses
    the vendor SDK because its working sync-with-power command is not exposed by
