...
def get_policy_class(name: str) -> type[PreTrainedPolicy]:
    ...
    if name == "tdmpc":
        ...
        # Importing rlt_pi05 has the side effect of registering PI05RLTConfig
        # ('pi05_rlt') with PreTrainedConfig.register_subclass(...).
        import lerobot.rl.rlt_pi05  # noqa: F401
        from lerobot.rl.rlt_pi05 import PI05RLTPolicy

        return PI05RLTPolicy
    elif name == "tinypi05_rlt":
        # Importing rlt_tinypi05 registers TinyPI05RLTConfig ('tinypi05_rlt')
        # with PreTrainedConfig.register_subclass(...).
        import lerobot.rl.rlt_tinypi05  # noqa: F401
...
def make_policy_config(policy_type: str, **kwargs) -> PreTrainedConfig:
    ...
    elif policy_type == "tinypi05v2":
        return TinyPI05V2Config(**kwargs)
...
def make_pre_post_processors(
    ...
    **kwargs: Unpack[ProcessorConfigKwargs],
    ...
    elif isinstance(policy_cfg, TinyPI05V2Config):
        from lerobot.policies.tinypi05v2.processor_tinypi05v2 import (
            make_tinypi05v2_pre_post_processors,
        )

        processors = make_tinypi05v2_pre_post_processors(
            config=policy_cfg,
            dataset_stats=kwargs.get("dataset_stats"),
        )
