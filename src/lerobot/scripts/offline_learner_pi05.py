...
from lerobot.robots.so_follower.config_so_follower import (
    SOFollowerRobotConfig,  # noqa: F401  # register so101/so100_follower
)
from lerobot.teleoperators.gamepad.configuration_gamepad import (
    GamepadTeleopConfig,  # noqa: F401  # register gamepad
)
from lerobot.teleoperators.so_leader.config_so_leader import (
    SOLeaderTeleopConfig,  # noqa: F401  # register so101/so100_leader
)
