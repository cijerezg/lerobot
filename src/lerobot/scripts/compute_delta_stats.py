...
def compute_action_stats(
    ...
    # Kept for the loader-side metadata check: stats files produced with the old
    # SO-101 v2.1 conversion carry "so101_v3_to_v21" here and are rejected.
    stats["frame_conversion"] = "none"
